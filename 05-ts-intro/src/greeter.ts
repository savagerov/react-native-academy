...
// // document.getElementById('results')!.innerHTML = greeter('Sava', new Date('1995-12-17T03:24:00'));

// const elem = document.getElementById('results');
// if(elem !== null) {
//     elem.innerHTML = greeter('Sava');
// }
